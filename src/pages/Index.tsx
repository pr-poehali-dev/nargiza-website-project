...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {selectedTrack && (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-t border-border shadow-2xl animate-slide-up">
          <div className="container mx-auto max-w-4xl p-4">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-semibold">{t('tracks.player')}</h4>
              <button
