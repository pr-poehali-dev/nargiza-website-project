      ...
      <section className="py-24 px-6 bg-gradient-to-b from-background via-accent/5 to-background">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground mb-4">Актуальные данные со стриминговых платформ</p>
            <Button
              variant="outline"
              size="sm"
              onClick={updateStreamingStats}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <Card className="overflow-hidden hover:shadow-xl transition-all">
                <CardContent className="p-8 text-center">
                  ...
                  <h4 className="text-2xl font-bold mb-2">Яндекс Музыка</h4>
                  <p className="text-4xl font-black text-primary mb-2">
                    {streamingStats.yandex.streams.toLocaleString('ru-RU')}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Обновлено: {new Date(streamingStats.yandex.updated_at).toLocaleDateString('ru-RU')}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden hover:shadow-xl transition-all">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-4xl font-black text-primary mb-2">
                    {streamingStats.spotify.streams.toLocaleString('ru-RU')}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Обновлено: {new Date(streamingStats.spotify.updated_at).toLocaleDateString('ru-RU')}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="overflow-hidden hover:shadow-xl transition-all">
                <CardContent className="p-8 text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 mb-4">
                    <Icon name="Music4" size={32} className="text-white" />
                  </div>
                  <h4 className="text-2xl font-bold mb-2">Apple Music</h4>
                  <p className="text-4xl font-black text-primary mb-2">
                    {streamingStats.apple.streams.toLocaleString('ru-RU')}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Обновлено: {new Date(streamingStats.apple.updated_at).toLocaleDateString('ru-RU')}
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          {historyData.length > 0 && (
            <Card className="overflow-hidden">
              <CardContent className="p-8">
                <h4 className="text-2xl font-bold mb-6 text-center">История прослушиваний</h4>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={historyData}>
                    <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                    <XAxis 
