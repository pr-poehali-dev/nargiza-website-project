...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'nav.albums': 'Альбомы',
    'nav.videos': 'Клипы',
    'hero.subtitle': 'Автор | Исполнитель',
    ...
    'meta.albums.title': 'Альбомы NARGIZA — Слушать онлайн | Официальный сайт',
    'meta.albums.description': 'Все альбомы NARGIZA: Никчёмная жизнь, Война, Украина, Курск, Россия и Сила. Слушайте полные треки на Яндекс.Музыке, Apple Music, Spotify.',
  ...
  en: {
    ...
    'nav.albums': 'Albums',
    'nav.videos': 'Videos',
    'hero.subtitle': 'Author | Performer',
    ...
    'meta.albums.title': 'NARGIZA Albums — Listen Online | Official Website',
    'meta.albums.description': 'All NARGIZA albums: Worthless Life, War, Ukraine, Kursk, Russia and Power. Listen to full tracks on Yandex.Music, Apple Music, Spotify.',
